...
<body>
    ...
    <main>
        <br>
        <h1 data-aos="fade-up" class="heading-1">Móviles y Accesorios</h1>
        <h1 data-aos="fade-up" class="heading-2" id="audifonos">Audífonos</h1>
        ...
        $sql = "SELECT * FROM productos WHERE seccion = 'Audifonos'";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<img class='dynamic-image' src='img/audifonos/" . $row['imagen'] . "' alt='" . $row['nombre'] . "' />";
                if ($stock == 0) {
        ...
        <h1 data-aos="fade-up" class="heading-2" id="celulares">Celulares</h1>
        <hr class="separator" data-aos="fade-up">
        <br>
        <br>
        ...
        $sql = "SELECT * FROM productos WHERE seccion = 'Celulares'";
        $result = $conn->query($sql);
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<div class='card-product' $click>";
                echo "<div class='container-img'>";
                echo "<img class='dynamic-image' src='img/celulares/" . $row['imagen'] . "' alt='" . $row['nombre'] . "' />";
                if ($stock == 0) {
                    echo "<img src='img/out_of_stock.png' alt='Sin stock' style='position:absolute;top:0;left:0;width:100%;height:100%;object-fit:contain;background-color:rgba(255,255,255,0.7);z-index:10;'>";
                }
                echo "</div>";
        ...
        <h1 data-aos="fade-up" class="heading-2" id="gadgets">Gadgets</h1>
        <hr class="separator" data-aos="fade-up">
        <br>
        <br>
        ...
        $sql = "SELECT * FROM productos WHERE seccion = 'Gadgets'";
        $result = $conn->query($sql);
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<div class='card-product' $click>";
                echo "<div class='container-img'>";
                echo "<img class='dynamic-image' src='img/gadgets/" . $row['imagen'] . "' alt='" . $row['nombre'] . "' />";
                if ($stock == 0) {
                    echo "<img src='img/out_of_stock.png' alt='Sin stock' style='position:absolute;top:0;left:0;width:100%;height:100%;object-fit:contain;background-color:rgba(255,255,255,0.7);z-index:10;'>";
                }
                echo "</div>";
