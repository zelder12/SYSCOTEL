...
<head>
    ...
    <style>
        ...
        /* Estilos mejorados para el carrito y contador */
        .cart-icon {
            position: relative;
...
<body>
    ...
    <main>
        <br>
        <h1 data-aos="fade-up" class="heading-1">Varios y Accesorios</h1>
        <h1 data-aos="fade-up" class="heading-2" id="seguridad">Seguridad</h1>
        ...
        $sql = "SELECT * FROM productos WHERE seccion = 'Seguridad'";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<img class='dynamic-image' src='img/seguridad/" . $row['imagen'] . "' alt='" . $row['nombre'] . "' />";
                if ($stock == 0) {
        ...
        <h1 data-aos="fade-up" class="heading-2" id="unidades">Unidades de red</h1>
        <hr class="separator" data-aos="fade-up">
        <br>
        <br>
        ...
        $sql = "SELECT * FROM productos WHERE seccion = 'Unidades'";
        $result = $conn->query($sql);

        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                $stock = isset($row['stock']) ? (int)$row['stock'] : 0;
                $click = $stock > 0 ? "onclick='showQuickView(\"{$row['nombre']}\", \"{$row['descripcion']}\", \"{$row['precio']}\", \"{$row['imagen']}\", \"{$row['seccion']}\", \"{$row['id']}\")'" : '';
                echo "<div class='card-product' $click>";
                echo "<div class='container-img'>";
                echo "<img class='dynamic-image' src='img/unidades/" . $row['imagen'] . "' alt='" . $row['nombre'] . "' />";
                if ($stock == 0) {
                    echo "<img src='img/out_of_stock.png' alt='Sin stock' style='position:absolute;top:0;left:0;width:100%;height:100%;object-fit:contain;background-color:rgba(255,255,255,0.7);z-index:10;'>";
                }
                echo "</div>";
        ...
        <h1 data-aos="fade-up" class="heading-2" id="varios">Varios</h1>
        <hr class="separator" data-aos="fade-up">
        <br>
        <br>
        ...
        $sql = "SELECT * FROM productos WHERE seccion = 'Varios'";
        $result = $conn->query($sql);
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<div class='card-product' $click>";
                echo "<div class='container-img'>";
                echo "<img class='dynamic-image' src='img/varios/" . $row['imagen'] . "' alt='" . $row['nombre'] . "' />";
                if ($stock == 0) {
                    echo "<img src='img/out_of_stock.png' alt='Sin stock' style='position:absolute;top:0;left:0;width:100%;height:100%;object-fit:contain;background-color:rgba(255,255,255,0.7);z-index:10;'>";
                }
                echo "</div>";
